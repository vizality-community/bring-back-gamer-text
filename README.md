...
# Bring Back Gamer Text

## Description

Brings back the older "gamer" texts that Discord used to use in various places around the app.

## Preview

![Better Code Blocks](screenshots/preview-1.png)
![Better Code Blocks](screenshots/preview-2.png)
